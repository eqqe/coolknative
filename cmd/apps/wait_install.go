...
func MakeWaitInstall() *cobra.Command {
	...
	waitInstall.RunE = func(command *cobra.Command, args []string) error {
		...
		err := kubectlWait("available", "kourier-system", "deployment", "3scale-kourier-control")
		if err != nil {
			return err
		}
		...
		err = kubectlWait("available", "monitoring", "deployment", "fluentd-deployment")
		if err != nil {
			return err
		}
		...
		err = kubectlWait("ready", "minio", "pod", "minio-0")
		if err != nil {
			return err
		}
		err = kubectlWait("ready", "minio", "pod", "minio-1")
		if err != nil {
			return err
		}
		err = kubectlWait("ready", "minio", "pod", "minio-2")
		if err != nil {
			return err
		}
		err = kubectlWait("ready", "minio", "pod", "minio-3")
		if err != nil {
			return err
		}
