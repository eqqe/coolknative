...
func MakeInstallKnativeEventing() *cobra.Command {
	...
	knativeEventing.RunE = func(command *cobra.Command, args []string) error {
		...
		res, err := kubectlTask("apply", "-f",
			"https://github.com/knative/eventing/releases/download/v0.17.0/eventing-crds.yaml")
		if err != nil {
			return err
		}
		if res.ExitCode != 0 {
		...
		res, err = kubectlTask("apply", "-f",
			"https://github.com/knative/eventing/releases/download/v0.17.0/eventing-core.yaml")
		if err != nil {
			return err
		}
		if res.ExitCode != 0 {
		...
		res, err = kubectlTask("apply", "-f",
			"https://github.com/knative/eventing/releases/download/v0.17.0/mt-channel-broker.yaml")
		if err != nil {
			return err
		}
		if res.ExitCode != 0 {
		...
		res, err = kubectlTask("apply", "-f",
			"https://github.com/knative/eventing/releases/download/v0.17.0/eventing-sugar-controller.yaml")
		if err != nil {
			return err
		}
		if res.ExitCode != 0 {
		...
		res, err = kubectlTask("apply", "-f",
			"https://github.com/knative/eventing-contrib/releases/download/v0.17.0/natss-channel.yaml")
		if err != nil {
			return err
		}
		if res.ExitCode != 0 {
